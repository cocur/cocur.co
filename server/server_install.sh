...
cp cocur.co.conf /etc/nginx/conf.d/cocur.co.conf
...
if [[ -f /var/www/cocur.co ]]; then
    # Clone repository and install NPM and Bower dependencies
    echo "Installing cocur.co from Github..."
    mkdir -p /var/www/cocur.co
    cd /var/www/cocur.co

    git clone https://github.com/cocur/cocur.co ./
